...
package com.adam.events{
	...
	public class EventManager{
		...
		public function listen(type:String, listener:Function) {
			dispatcher.addEventListener(type, listener);
		}
		
		public function stopListening(type:String, listener:Function) {
			dispatcher.removeEventListener(type, listener);
		}
		
		public function dispatch(eventName:String, paramObj:Object) {
