...
package com.dave.mediaplayers {
	...
	public class SoundManager extends Object {
		...
		public function setGlobalVolume(vol:Number){
			_highestVolume = vol;
		...
		public function addSound(_linkageName:String, _loopCount:Number=0, autoStart:Boolean=false){
		...
		public function removeSound(_linkageName:String){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
		...
		public function soundAdded(_linkageName:String){
			return(_sounds[_linkageName] != undefined && _sounds[_linkageName] != null);
		}
		
		
		public function playSound(_linkageName:String, resetVolume:Boolean=false){
		...
		public function playSoundEvent(_linkageName:String, resetVolume:Boolean=false){
		...
		public function stopSound(_linkageName:String){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
		...
		public function pauseSound(_linkageName:String){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
				if (_sounds[_linkageName].isPlaying){
		...
		public function unpauseSound(_linkageName:String){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
				if (!_sounds[_linkageName].isPlaying){
		...
		public function setVolume(_linkageName:String, num:Number){ // 0-1
		...
		public function fadeTo(_linkageName:String, num:Number, milliseconds:Number){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
				if ((!USE_GLOBAL_MUTE && !_mute) || USE_GLOBAL_MUTE){
		...
		public function fadeInAndStart(_linkageName:String, milliseconds:Number){
			fadeIn(_linkageName, milliseconds);
		}
		
		public function fadeIn(_linkageName:String, milliseconds:Number){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
				if ((!USE_GLOBAL_MUTE && !_mute) || USE_GLOBAL_MUTE){
					if (_sounds[_linkageName].isPlaying == false){
						_sounds[_linkageName].channel = _sounds[_linkageName].soundObject.play(0,_sounds[_linkageName].loopCount);
		...
		public function fadeOut(_linkageName:String, milliseconds:Number){
			if ((!USE_GLOBAL_MUTE && !_mute) || USE_GLOBAL_MUTE){
				fadeTo(_linkageName, 0, milliseconds);
			}
		}
		
		public function fadeOutAndStop(_linkageName:String, milliseconds:Number){
			if (_sounds[_linkageName] != undefined && _sounds[_linkageName] != null){
				if ((!USE_GLOBAL_MUTE && !_mute) || USE_GLOBAL_MUTE){
					fadeTo(_linkageName,0,milliseconds);
					if (_linkageName.indexOf(".mp3",0) != -1){
						_sounds[_linkageName].fadeTimer.data.onComplete = function(target:Object){ try { target.soundObject.close(); } catch (e:Error){} target.isPlaying = false; };
					} else {
						_sounds[_linkageName].fadeTimer.data.onComplete = function(target:Object){ target.channel.stop(); target.isPlaying = false; };
					}
				}
			}
		}
		
		private function fader(e:TimerEvent){
			if ((!USE_GLOBAL_MUTE && !_mute) || USE_GLOBAL_MUTE){
				try {
