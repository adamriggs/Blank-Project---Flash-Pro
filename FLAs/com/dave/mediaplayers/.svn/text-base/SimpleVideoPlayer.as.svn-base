...
package com.dave.mediaplayers {
	...
	public class SimpleVideoPlayer extends Sprite {
		...
		public var _w,_h,_x,_y:int;
		public var _bufferTime:Number;
		public var _autoStart,_stopped,_paused:Boolean;
		...
		public function SimpleVideoPlayer(xPos:int, yPos:int, w:int, h:int, autoStart:Boolean, bufferTimeDuration:Number, globalNetConnection:NetConnection, parentObject:Object, origSize:Boolean=false, smoothing:Boolean=false){
		...
		private function createBufferIndicator(){
		...
		public function playVideo( ...videos ){
		...
		private function playVid(vid:String){
		...
		public function pauseAndRewindVideo(){
			
			rewindVideo();
			pauseVideo();
		}
		public function rewindAndPauseVideo(){
			
			rewindVideo();
			pauseVideo();
		}
		
		public function unpauseVideo(){
		...
		public function onMetaData(data:Object){
		...
		public function onCuePoint(cuePoint:Object){
