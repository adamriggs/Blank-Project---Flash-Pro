...
package com.dave.mediaplayers {
	...
	public class YouTubePlayer extends Sprite {
		...
		protected function onPlayerReady(event:Event):void {
			...
			trace("YouTubePlayer.onPlayerReady:", event);
			...
			dispatchEvent(event);
			EventCenter.broadcast("youTubePlayer", {type:"onReady"});
		}
		...
		protected function brandQualityButton(qualityType:String, hilighted:Boolean=false){
