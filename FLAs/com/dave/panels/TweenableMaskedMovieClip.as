...
package com.dave.panels {
	...
	public class TweenableMaskedMovieClip extends MovieClip {
		...
		public function tweenMask(newWidth:Number, newHeight:Number, transtime:Number, transitiontype:String="easeInOutQuad", completed:Function=null){
		...
		public function setMaskSize(innerWidth, innerHeight){
			_innerWidth = innerWidth;
			_innerHeight = innerHeight;
