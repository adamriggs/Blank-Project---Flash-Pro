...
package com.dave.panels {
	...
	public class ScrollableMovieClip extends MovieClip {
		...
		public function ScrollableMovieClip(innerWidth:Number, innerHeight:Number){
		...
		private function scrollnub_onPress(e:MouseEvent){
		...
		private function scrollnub_onRelease(e:MouseEvent){
			scrollnub.stopDrag();
			inner.removeEventListener(Event.ENTER_FRAME, inner_onEnterFrame);
		...
		private function scrollnub_onMouseOut(e:MouseEvent){
			if(e.buttonDown){   
