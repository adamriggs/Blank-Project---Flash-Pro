...
package com.dave.panels {
	...
	public class ThumbnailScroller extends Sprite {
		...
		public function arrow_left_click(e:Event){
			if (!isSliding){
				slide(-1);
			}
		}
		
		public function arrow_right_click(e:Event){
			if (!isSliding){
				slide(1);
			}
		}
		
		public function onSlideLeft(){
			
		}
		
		public function onSlideRight(){
		...
		public function slide(direction:Number){
			if (!isSliding){
